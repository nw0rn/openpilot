...
/usr/bin/docker buildx build --cache-from type=gha --cache-to type=gha,mode=max --iidfile /home/runner/work/_temp/docker-actions-toolkit-750cnR/iidfile --provenance mode=max,builder-id=https://github.com/nw0rn/openpilot/actions/runs/9159568519 --tag ghcr.io/nw0rn/openpilot:123 --metadata-file /home/runner/work/_temp/docker-actions-toolkit-750cnR/metadata-file --push .
